...
export interface ChemicalTreatmentSpec {
	...
	chemicalTreatmentMethodCode: ChemicalTreatmentMethodCode;
}
...
export class ChemicalTreatment extends Record implements ChemicalTreatmentSpec {
	...
	@JoinColumn({ name: ChemicalTreatmentSchema.columns.chemicalTreatmentMethodCode, referencedColumnName: ChemicalTreatmentMethodCodeSchema.pk})
	@ModelProperty({type: PropertyType.object})
	chemicalTreatmentMethodCode: ChemicalTreatmentMethodCode;
