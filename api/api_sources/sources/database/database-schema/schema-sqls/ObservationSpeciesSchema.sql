...
ALTER TABLE observation_species ADD COLUMN area_width NUMERIC(4, 3) NULL DEFAULT 0.0;
ALTER TABLE observation_species ADD COLUMN area_length NUMERIC(4, 3) NULL DEFAULT 0.0;
