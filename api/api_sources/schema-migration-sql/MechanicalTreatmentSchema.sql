...
ALTER TABLE mechanical_treatment ADD COLUMN mechanical_treatment_area_horizontal_dimension NUMERIC(7, 2) NULL DEFAULT 0.0;
ALTER TABLE mechanical_treatment ADD COLUMN mechanical_treatment_area_vertical_dimension NUMERIC(7, 2) NULL DEFAULT 0.0;
